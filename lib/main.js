...
{
    tabs.open("http://www.noteboardapp.com/firefoxExtensionWelcome");
...
function abrePopup()
{
    ...
    else
    {
        ...
        {
            if (tab.url == "http://www.noteboardapp.com/firefoxBoard" ||
                tab.url == "http://www.noteboardapp.com/board" ||
                tab.url == "http://www.noteboardapp.com/board.php")
            {
                tabOpen = true;
                tab.activate();
            }
        }
        if (!tabOpen) tabs.open("http://www.noteboardapp.com/firefoxBoard");
    }
}
...
function abreLogin()
{
    ...
    panel.port.on("loged", function(datos){
        ...
        panel.hide();
        if (primera) tabs.open("http://www.noteboardapp.com/loginPageFire");
    ...
    panel.port.on("registered", function(datos){
        ...
        panel.hide();
         if (primera) tabs.open("http://www.noteboardapp.com/loginPageFireReg");
        listenFacebook = false;
    });
    panel.port.on("goDemo", function(datos){
        ...
        panel.hide();
        if (primera) tabs.open("http://www.noteboardapp.com/boarddemo");
        listenFacebook = false;
    });
    ...
    if (tab.url == 'http://www.noteboardapp.com/loginPageFire')
    {
            worker = tab.attach({
                contentScriptFile:  [data.url("jquery/jquery.js"),
                                     data.url("varios.js"),
    ...
    if (tab.url == 'http://www.noteboardapp.com/loginPageFireReg')
    {
            worker = tab.attach({
                contentScriptFile:  [data.url("jquery/jquery.js"),
                                     data.url("varios.js"),
    ...
    if (tab.url == 'http://www.noteboardapp.com/loginPage')
    {
  ...
  Request({
    ...
    onComplete: function(answer){
        ...
        if (resp.isSuccess)
        {
            ...
            panel.hide();
            if (resp.nuevoReg) tabs.open("http://www.noteboardapp.com/loginPageFireReg");
            else tabs.open("http://www.noteboardapp.com/loginPageFire");
